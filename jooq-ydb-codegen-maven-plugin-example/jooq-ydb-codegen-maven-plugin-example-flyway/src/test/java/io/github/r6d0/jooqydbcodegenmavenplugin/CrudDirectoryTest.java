...
import static io.github.r6d0.jooqydbcodegenmavenplugin.directory_test.tables.FlywayDirectoryTest.FLYWAY_DIRECTORY_TEST;
...
class CrudDirectoryTest {
  ...
  void updateTest() {
    ...
    context
      ...
      .set(DSL.field(FLYWAY_DIRECTORY_TEST.TEXT.getName()), newValue)
      .where(DSL.field(FLYWAY_DIRECTORY_TEST.ID.getName()).eq(1L))
      .execute();
